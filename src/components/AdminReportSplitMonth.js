...
export const AdminReportSplitMonth = () => {
  ...
  const [noDataText] = useState(
    'Valitse ylempää haluttu vuosi, kuukausi ja raportin tyyppi. Paina sitten HAE TIEDOT. Raportti antaa tiedot kun puolesta välistä puoleen väliin (15.x - 14.y).'
  )
  ...
  const getReportData = () => {
    api
      .get('/admin/monthlyreportsplitmonth', {
        params: {
          createdYear: year,
          createdMonth: month,
        },
    ...
    <div>
      <div className={classes.parameterSelections}>
        ...
        <FormControl className={classes.parameterItem}>
          ...
          >
            <MenuItem value={1}>Joulu-Tammikuu</MenuItem>
            <MenuItem value={2}>Tammi-Helmikuu</MenuItem>
            <MenuItem value={3}>Helmi-Maaliskuu</MenuItem>
            <MenuItem value={4}>Maalis-Huhtikuu</MenuItem>
            <MenuItem value={5}>Huhti-Toukokuu</MenuItem>
            <MenuItem value={6}>Touko-Kesäkuu</MenuItem>
            <MenuItem value={7}>Kesä-Heinäkuu</MenuItem>
            <MenuItem value={8}>Heinä-Elokuu</MenuItem>
            <MenuItem value={9}>Elo-Syyskuu</MenuItem>
            <MenuItem value={10}>Syys-Lokakuu</MenuItem>
            <MenuItem value={11}>Loka-Marraskuu</MenuItem>
            <MenuItem value={12}>Marras-Joulukuu</MenuItem>
          </Select>
        </FormControl>
